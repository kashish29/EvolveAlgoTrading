...
class TestDataFeedSimulator(unittest.TestCase):
    ...
    def test_yields_candle_and_order_update_events(self):
        ...
        mock_order_update = Order(
            order_id="test_order_123", symbol="SYM1", quantity=10, side=OrderSide.BUY,
        ...
        self.assertEqual(events[2].order_id, "test_order_123")
    ...
    def test_handles_invalid_timeframe_string(self):
        ...
        self.assertIn("Invalid timeframe string 'bad_tf'", log_cm.output[0])
    ...
    def test_handles_missing_essential_column(self):
        ...
        self.assertIn("Missing essential column 'close'", log_cm.output[0])
